...
BOT_TOKEN = environ.get('BOT_TOKEN', "6717402898:AAHJn0wiAoAuPpCMjqypmtkgZ4WSnnjAzL4")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001933509863')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DjmixpurFilterbot:7872278427kd@filterbot.elbmevn.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002082842572')).split()]
