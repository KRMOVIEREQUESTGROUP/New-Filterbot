...
async def give_filter(client, message):
    ...
    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📷 ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🎥 ", url=f"https://t.me/kdmovierequest")]])
)
    ...
    try:
        if settings['max_btn']:
            if 0 < offset <= 10:
                ...
                off_set = offset - 10
            if n_offset == 0:
                btn.append([InlineKeyboardButton(text="🔗 𝖧𝗈𝗐 𝖳𝗈 𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽 🔗", url="https://t.me/how_Download_Tr/9")])
                btn.append(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 InlineKeyboardButton('Jᴏɪɴ Cʜᴀɴɴᴇʟ', url="https://telegram.me/krbackup"),
                 InlineKeyboardButton("Vɪᴇᴡ Sᴛᴀᴛᴜs", url=f"{query.message.link}")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://kdmovierequest")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://telegram.me/kdmovierequest")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('★ 𝖢𝗁𝖺𝗇𝗇𝖾𝗅', url='https://t.me/krbackup'),
                    InlineKeyboardButton('♧︎︎︎ 𝖬𝗈𝗏𝗂𝖾 𝖦𝗋𝗈𝗎𝗉', url="https://t.me/kdmovierequest")
                ],[
                    InlineKeyboardButton('ꕥ 𝖧𝖾𝗅𝗉', callback_data='help'),
                    InlineKeyboardButton('♕︎ 𝖠𝖻𝗈𝗎𝗍', callback_data='about') 
                ],[
                    InlineKeyboardButton('𖤍 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𖤍', callback_data='suprt_info') 
                ]]       
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𖣘 𝖦𝗅𝗈𝖻𝖺𝗅 𝖥𝗂𝗅𝗍𝖾𝗋𝗌', callback_data='global_filters')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('✫ 𝖠𝖽𝗆𝗂𝗇 𝖯𝖺𝗇𝖾𝗅 ✫', callback_data='admin')            
         ], [
             InlineKeyboardButton('𓆈 𝖥𝗂𝗅𝖾 𝖲𝗍𝗈𝗋𝖾', callback_data='store_file'),   
             InlineKeyboardButton('𓃗 𝖳𝖾𝗅𝗀𝗋𝖺𝗉𝗁', callback_data='tele') 
         ], [ 
             InlineKeyboardButton('𓅷 𝖢𝗈𝗇𝗇𝖾𝖼𝗍', callback_data='coct'), 
             InlineKeyboardButton('𓃠 𝖥𝗂𝗅𝗍𝖾𝗋𝗌', callback_data='filters') 
         ], [           
            InlineKeyboardButton('𓆙 𝖤𝗑𝗍𝗋𝖺 𝖬𝗈𝖽𝖾', callback_data='extmod'), 
            InlineKeyboardButton('𓃰 𝖤𝗑𝗍𝗋𝖺 𝖥𝖾𝖺𝗍𝗎𝗋𝖾', callback_data='extra')
         ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🛰 𝖲𝖾𝗋𝗏𝖾𝗋 𝖲𝗍𝖺𝗍𝗎𝗌', callback_data='rendering_info'),           
        ...
        buttons = [[
             InlineKeyboardButton('♔︎ 𝖬𝖺𝗂𝗇 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 ♔︎', url='https://t.me/krbackup')
         ],[ 
             InlineKeyboardButton('𐂃 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉', url='https://t.me/krbackup'),
             InlineKeyboardButton('𐂂 𝖬𝗈𝗏𝗂𝖾𝗌 𝖴𝗉𝖽𝖺𝗍𝖾', url='https://t.me/kdmovierequest') 
         ],[ 
             InlineKeyboardButton('𓅓 𝖬𝗈𝗏𝗂𝖾𝗌 𝖦𝗋𝗈𝗎𝗉', url='https://t.me/kdmovierequest'), 
             InlineKeyboardButton('🤖 𝖡𝗈𝗍 𝖴𝗉𝖽𝖺𝗍𝖾𝗌', url='https://t.me/krbackup') 
         ],[ 
             InlineKeyboardButton('⟸ 𝖡𝖺𝖼𝗄', callback_data='start')
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
        InlineKeyboardButton('𖣔 𝖲𝗈𝗎𝗋𝖼𝖾 𝖢𝗈𝖽𝖾', url='https://t.me/kd_bhai_admin')
        ], [
